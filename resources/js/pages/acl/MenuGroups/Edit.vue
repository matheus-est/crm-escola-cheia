...
import { index, update } from '@/routes/menu-groups';
...
const breadcrumbItems: BreadcrumbItem[] = [
    ...
    { title: 'Edit Grupo Menu', href: '#' },
];

const form = useForm({
    name: props.menuGroup.name,
    slug: props.menuGroup.slug,
    icon: props.menuGroup.icon ?? '',
    order: props.menuGroup.order,
    is_active: props.menuGroup.is_active,
});
...
function handleSubmit() {
    form.put(update(props.menuGroup.uuid).url, {
        onError: () => {},
    });
}
</script>
    ...
    <AppLayout :breadcrumbs="breadcrumbItems">
        ...
        <div class="space-y-4">
            <div class="flex items-center gap-4">
                ...
                <Heading :title="$t('menu_groups.edit')" />
            </div>
